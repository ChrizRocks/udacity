...
public class CarControllerTest {
    ...
    public void deleteCar() throws Exception {
         ...
         */
        Car deletableCar = getCar(); //new car to not interfere with other tests
        deletableCar.setId(2L); //set ID to 2L
        deletableCar.setCondition(Condition.NEW); //change condition to NEW
        ResultActions resultActions = mvc.perform(get("/cars/2")
                .accept(MediaType.APPLICATION_JSON_UTF8)
                .contentType(MediaType.APPLICATION_JSON_UTF8))
                .andExpect(status().isOk());
        verify(carService,times(1)).findById(2L); //verify that car was found
        MvcResult mvcResult= resultActions.andReturn();
        System.out.println("#############################");
        System.out.println(mvcResult.getResponse().getContentAsString());
        System.out.println("#############################");
        mvc.perform(delete("/cars/2") //perform delete
                .accept(MediaType.APPLICATION_JSON_UTF8)
                .contentType(MediaType.APPLICATION_JSON_UTF8))
